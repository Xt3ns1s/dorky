...
#cutom intitle search
def intitle():
	search=input ("Custom intitle search: ")
	print (search)
	webbrowser.open ("www.google.com/search?q=intitle: " + search, new=1)
